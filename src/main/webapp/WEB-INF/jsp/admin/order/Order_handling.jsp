                    ...
                    <div class="widget-box side_content">
                        ...
                        <div class="side_list">
                            <div class="widget-header header-color-green2">
                                <h4 class="lighter smaller">订单操作</h4></div>
                            <div class="widget-body">
                                <ul class="b_P_Sort_list">
                                    <li>
                                        <i class="orange  fa fa-reorder"></i>
                                        <a href="#">全部订单(235)</a></li>
                                    <li>
                    ...
                    <div class="search_style">
                        <ul class="search_content clearfix">
                            <li>
                                ...
                                <input name="" type="text" class="text_add" placeholder="输入订单编号" style=" width:250px" /></li>
                            <li>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="order_product_name">
                                        <a href="#" class="product_Display">
                                            <img src="${PATH }/admin/products/p_1.jpg" title="产品名称" /></a>
                                        <i class="fa fa-plus"></i>
                                        <a href="#" class="product_Display">
                                            <img src="${PATH }/admin/products/p_2.jpg" title="产品名称" /></a>
                                    </td>
                                    <td>456.5</td>
                                    <td>2016-7-5</td>
                                    <td>食品</td>
                                    <td>2</td>
                                    <td class="td-status">
                                        <span class="label label-success radius">代发货</span></td>
                                    <td></td>
                                    <td>
                                        <a onClick="Delivery_stop(this,'10001')" href="javascript:;" title="发货" class="btn btn-xs btn-success">
                                            <i class="fa fa-cubes bigger-120"></i>
                                        </a>
                                        <a title="订单详细" href="order_detailed.html" class="btn btn-xs btn-info order_detailed">
                                ...
                                <tr>
                                    ...
                                    <td class="order_product_name">
                                        <a href="#" class="product_Display">
                                            <img src="${PATH }/admin/products/p_1.jpg" title="产品名称" /></td>
                                    <td>456.5</td>
                                    <td>2016-7-5</td>
                                    <td>食品</td>
                                    <td>2</td>
                                    <td class="td-status">
                                        <span class="label label-success radius">失败</span></td>
                                    <td>支付失败</td>
                                    <td>
                                        <a title="订单详细" href="order_detailed.html" class="btn btn-xs btn-info order_detailed">
                                            <i class="fa fa-list bigger-120"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="form-field-select-1">
                                ...
                                <option value="8">韵达快递</option></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">快递号</label>
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" placeholder="快递号" class="col-xs-10 col-sm-5" style="margin-left:0px;"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2</td>
                                    <td class="td-status">
                                        <span class="label label-success radius">待发货</span></td>
                                    <td></td>
                                    <td>
                                        <a onClick="Delivery_stop(this,'10001')" href="javascript:;" title="发货" class="btn btn-xs btn-success">
                                            <i class="fa fa-cubes bigger-120"></i>
